...
<body>
	<%-- /include/navbar.jsp 페이지에게 이부분을 응답하도록 한다
		<jps:include page="webapp 내에서의 jsp 페이지 경로">
	...
	<div class="container">
		...
		<ul class="nav flex-column">
			<li class="nav-itm"><a class="nav-link" href="${pageContext.request.contextPath }/test.jsp">Connection 객체 얻어오기 테스트</a></li>
			<li class="nav-itm"><a class="nav-link" href="${pageContext.request.contextPath }/member/list.jsp">회원목록 보기</a></li>
			<li class="nav-itm"><a class="nav-link" href="${pageContext.request.contextPath }/friend/list.jsp">친구목록 보기</a></li>
			<li class="nav-itm"><a class="nav-link" href="${pageContext.request.contextPath }/guest/list.jsp">방명록</a></li>
		</ul>
